...
#define CONFIG_BOOTARGS		"root=/dev/mmcblk0p2 rootfstype=ext3 rw init=/init console=ttySAC2,115200 androidboot.console=s3c2410_serial2 rootdelay=1"

#define CONFIG_EXTRA_ENV_SETTINGS 	\
	"args_mmc=setenv bootargs 'root=/dev/mmcblk0p2 rootfstype=ext3 rw init=/init console=ttySAC2,115200 androidboot.console=s3c2410_serial2 rootdelay=1';sav\0" \
	"args_ram=setenv bootargs 'root=/dev/tfsr6 rootfstype=cramfs console=ttySAC2,115200 init=/linuxrc androidboot.console=s3c2410_serial2';sav\0" \
	"dnwu=dnw 30008000; movi write u-boot 30008000\0" \
	"dnwk=dnw 30008000; movi write kernel 30008000\0" \
	"dnwr=dnw 30008000; movi write rootfs 30008000 300000\0" \
	""
 ...
 */
#define CONFIG_IDENT_STRING	" for HKDKC110 D Type"
