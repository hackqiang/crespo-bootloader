...
#<BL1 fusing>
echo "BL1 fusing"
dd iflag=dsync oflag=dsync if=c110.signedBL1_bin of=$1 seek=1

####################################
#<u-boot fusing>
echo "u-boot fusing"
dd iflag=dsync oflag=dsync if=../u-boot.bin of=$1 seek=9 count=16
dd iflag=dsync oflag=dsync if=../u-boot.bin of=$1 seek=57
